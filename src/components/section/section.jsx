...
export const Section = () => {
    return <div className="bg-green-300 w-[100%] h-[125vh] flex items-center justify-center" >
        <div className="w-[79%] h-[820px]  flex flex-wrap gap-5">
            <div className='product flex items-end'>
                <h1 className='section__text ml-5 w-[200px] font-medium text-green-400 mb-20'>
                    Колбасные
            ...
            <div className="product2 flex items-end">
                <div className='product__div text-blue-700 mb-10 ml-5'>
